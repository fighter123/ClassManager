...
<form class="layui-form" action="theStudentGrade"> 
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <select name="StudentId" id="clasId" lay-verify="required" lay-search="">
          <option value="">直接选择或搜索选择</option>
          <s:iterator value="students">
			<option value=<s:property value="studentId"/>><s:property value="studentName"/></option>
		  </s:iterator>
        </select>
      </div>
    </div>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 0px;">
  <legend>学生<s:property value="student.studentName"/>的所有成绩：</legend>
</fieldset>
<%int n=-1;%>
<s:iterator value="studentGrades">
<s:if test="grade>60">
<%n=n+1;%>
</s:if>
</s:iterator>
<center>总学分:<s:property value="zongXueFen"/>分&nbsp;&nbsp;不及格课程(红色标出)：<%=n%>门</center>
