...
<form class="layui-form" action="">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input name="courseId" id="courseId" lay-verify="required" placeholder="请输入" style="width:239px" class="layui-input" type="text">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input name="courseName" id="courseName" lay-verify="required" placeholder="请输入" style="width:239px" class="layui-input" type="text">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input name="courseCredits" id="courseCredits" lay-verify="required" placeholder="请输入" style="width:239px" class="layui-input" type="text">
    </div>
  </div>
<br>
  <div class="layui-form-item">
...
/*     layer.alert(JSON.stringify(data.field), {
   ...
   /*  var datas=JSON.stringify(data.field);
    ...
    var courseProperty=$("input[name='courseProperty']:checked").val();
